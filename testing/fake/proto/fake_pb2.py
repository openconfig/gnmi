...
StringListValue = _reflection.GeneratedProtocolMessageType('StringListValue', (_message.Message,), dict(
...
UintList = _reflection.GeneratedProtocolMessageType('UintList', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z7github.com/openconfig/gnmi/testing/fake/proto;gnmi_fake'))
