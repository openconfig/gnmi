...
_CONFIGURATION_METAENTRY = _descriptor.Descriptor(
  name='MetaEntry',
  full_name='target.Configuration.MetaEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='target.Configuration.MetaEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='target.Configuration.MetaEntry.value', index=1,
...
_CONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta', full_name='target.Configuration.meta', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='revision', full_name='target.Configuration.revision', index=4,
  ...
  nested_types=[_CONFIGURATION_REQUESTENTRY, _CONFIGURATION_TARGETENTRY, _CONFIGURATION_METAENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_CONFIGURATION_METAENTRY.containing_type = _CONFIGURATION
...
_CONFIGURATION.fields_by_name['meta'].message_type = _CONFIGURATION_METAENTRY
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z\'github.com/openconfig/gnmi/proto/target'))
...
_CONFIGURATION_METAENTRY.has_options = True
_CONFIGURATION_METAENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_TARGET_METAENTRY.has_options = True
_TARGET_METAENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
