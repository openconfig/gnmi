...
_UPDATERESULT_OPERATION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNION_REPLACE', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_NOTIFICATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='gnmi.Notification.update', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delete', full_name='gnmi.Notification.delete', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='atomic', full_name='gnmi.Notification.atomic', index=4,
...
_TYPEDVALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='double_val', full_name='gnmi.TypedValue.double_val', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decimal_val', full_name='gnmi.TypedValue.decimal_val', index=7,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='leaflist_val', full_name='gnmi.TypedValue.leaflist_val', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='any_val', full_name='gnmi.TypedValue.any_val', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='json_val', full_name='gnmi.TypedValue.json_val', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='json_ietf_val', full_name='gnmi.TypedValue.json_ietf_val', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ascii_val', full_name='gnmi.TypedValue.ascii_val', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proto_bytes', full_name='gnmi.TypedValue.proto_bytes', index=13,
...
_SUBSCRIBEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='extension', full_name='gnmi.SubscribeRequest.extension', index=2,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBSCRIPTIONLIST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='qos', full_name='gnmi.SubscriptionList.qos', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='gnmi.SubscriptionList.mode', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_aggregation', full_name='gnmi.SubscriptionList.allow_aggregation', index=4,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_models', full_name='gnmi.SubscriptionList.use_models', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='gnmi.SubscriptionList.encoding', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updates_only', full_name='gnmi.SubscriptionList.updates_only', index=7,
...
_SETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='union_replace', full_name='gnmi.SetRequest.union_replace', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='extension', full_name='gnmi.SetRequest.extension', index=5,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TYPEDVALUE.oneofs_by_name['value'].fields.append(
  _TYPEDVALUE.fields_by_name['double_val'])
_TYPEDVALUE.fields_by_name['double_val'].containing_oneof = _TYPEDVALUE.oneofs_by_name['value']
_TYPEDVALUE.oneofs_by_name['value'].fields.append(
...
_TYPEDVALUE.fields_by_name['float_val'].has_options = True
_TYPEDVALUE.fields_by_name['float_val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_TYPEDVALUE.fields_by_name['decimal_val'].has_options = True
_TYPEDVALUE.fields_by_name['decimal_val']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
...
_DECIMAL64.has_options = True
_DECIMAL64._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
